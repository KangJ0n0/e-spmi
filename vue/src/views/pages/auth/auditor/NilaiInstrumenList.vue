<template>
  <div class="p-6 bg-white rounded-lg shadow-sm min-h-screen">
    <div class="mb-6 border-b border-gray-200 pb-4">
      <h1 class="text-2xl font-bold text-gray-800">Jawaban & Penilaian</h1>
      <p class="text-sm text-gray-500 mt-1">
        Pilih jadwal untuk membaca jawaban Auditee dan memberi nilai KS/KTS beserta rekomendasi.
      </p>
    </div>
...
<script setup>
// Halaman BARU (11 Sep 2026) - pecahan dari JadwalAuditor.vue lama, lihat catatan lengkap di
// PilihPertanyaanList.vue (file kembar halaman ini, sama-sama pecahan dari JadwalAuditor.vue).
// Halaman ini fokus cuma buat alur "Jawaban & Penilaian" (baca jawaban Auditee + kasih nilai) -
// label direvisi user dari "Nilai Instrumen" jadi "Jawaban & Penilaian" di pesan susulan, nama
// file/route dibiarkan sama.
