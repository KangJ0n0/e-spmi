<template>
  <div class="p-6 bg-white rounded-lg shadow-sm min-h-screen">
    <div class="mb-6 border-b border-gray-200 pb-4">
      <h1 class="text-2xl font-bold text-gray-800">Pilih Instrumen</h1>
      <p class="text-sm text-gray-500 mt-1">
        Pilih jadwal di mana Anda ditugaskan sebagai Auditor untuk memilih pertanyaan instrumen
        yang akan dikirim ke Auditee.
      </p>
    </div>
...
<script setup>
// Halaman BARU (11 Sep 2026) - pecahan dari JadwalAuditor.vue lama yang menggabungkan 2 aksi
// ("Lihat Jawaban & Nilai" + "Pilih Pertanyaan") dalam 1 halaman. User minta dipisah jadi 2
// halaman per role biar nggak "terlalu banyak merangkum hal jadi satu". Halaman ini fokus
// cuma buat alur "Pilih Instrumen" (kirim instrumen ke Auditee) - label direvisi user dari
// "Pilih Pertanyaan" jadi "Pilih Instrumen" di pesan susulan, nama file/route dibiarkan sama.
// Fetch data sama persis dengan JadwalAuditor.vue (file lama, sekarang jadi dead code - tidak
// ditautkan dari sidebar lagi, lihat useSidebar.js).
