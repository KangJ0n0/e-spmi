...
const icons = {
  ...
  // 2 ikon baru (15 Sep 2026) - "Berkas Instrumen" & "Konfigurasi Dokumen" sebelumnya sama-sama
  // pakai 'file' (dua-duanya kembar di sidebar Admin, dilaporkan user "ada yang sama").
