<template>
  <div class="bg-white font-poppins min-h-screen">
    ...
    <div v-if="submitted" class="max-w-2xl mx-auto px-6 py-24 text-center">
      <div
        class="h-16 w-16 rounded-full bg-[#C9A227]/15 flex items-center justify-center mx-auto mb-6"
      >
        <svg
      ...
      <p class="text-gray-500 leading-relaxed mb-8">
        Jawaban Anda telah kami terima dan akan menjadi masukan berharga bagi peningkatan mutu
        layanan UNWIKU.
      </p>
      <router-link
        to="/"
    ...
    <div v-else class="max-w-2xl mx-auto px-6 pt-10 pb-24">
      ...
      <p class="text-gray-500 leading-relaxed mb-8">
        Mohon isi identitas dan 10 pertanyaan berikut secara jujur. Jawaban Anda bersifat rahasia
        dan hanya digunakan untuk keperluan penjaminan mutu UNWIKU.
      </p>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-12">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              ...
              >
                ...
                <option v-for="prodi in daftarProdi" :key="prodi" :value="prodi">
                  {{ prodi }}
                </option>
              </select>
            </div>
        ...
        <section>
          ...
          <p class="text-xs text-gray-400 mb-6">1 = Sangat Tidak Puas &middot; 5 = Sangat Puas</p>
...
const isFormValid = computed(
  () => isIdentityValid.value && answeredCount.value === questions.length,
)
