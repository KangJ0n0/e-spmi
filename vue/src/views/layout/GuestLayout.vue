<template>
  <div class="min-h-screen flex flex-col bg-white font-poppins">
      ...
      <div class="flex items-center justify-between px-6 md:px-12 h-20">
        ...
        <router-link to="/" class="flex items-center gap-3 shrink-0">
          ...
          <div class="hidden sm:flex flex-col leading-none">
            ...
            <span class="text-white/75 text-[11px] tracking-[0.2em] font-semibold mt-0.5 drop-shadow-sm">UNIVERSITAS WIJAYAKUSUMA</span>
          </div>
        </router-link>
          ...
          >
            ...
            <transition name="dropdown">
              ...
              >
                ...
                <div class="absolute top-2.5 left-1/2 -translate-x-1/2 h-3 w-3 rotate-45 bg-white border-l border-t border-gray-100"></div>

                <div class="relative bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(15,42,74,0.35)] border border-gray-100 overflow-hidden">
                  <p class="px-5 pt-4 pb-2 text-[10px] font-semibold tracking-[0.15em] text-gray-400 uppercase">
                    {{ menu.eyebrow }}
                  </p>
                  ...
                  <div v-if="menu.cycle" class="px-2 pb-3">
                    ...
                    >
                      ...
                      <span class="text-sm text-gray-700 group-hover:text-[#0F2A4A] font-medium transition-colors">
                        {{ item.label }}
                      </span>
                    </component>
                  </div>
    ...
    <footer class="bg-[#081B33] text-blue-100">
      <div class="max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-[1.3fr_1fr_1fr] gap-10 text-sm">
        <div>
          ...
          <p class="text-blue-200/80 leading-relaxed max-w-xs">
            Lembaga Penjaminan Mutu Universitas Wijayakusuma Purwokerto —
            menjaga siklus Penetapan, Pelaksanaan, Evaluasi, Pengendalian,
            dan Peningkatan mutu secara berkelanjutan.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2.5 text-blue-200/80">
            <li><router-link to="/profil/visi" class="hover:text-[#C9A227] transition-colors">Profil</router-link></li>
            <li><router-link to="/spmi/penetapan" class="hover:text-[#C9A227] transition-colors">SPMI</router-link></li>
            <li><router-link to="/login" class="hover:text-[#C9A227] transition-colors">E-SPMI</router-link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2.5 text-blue-200/80">
            ...
            <li>Jl. Raya Beji Karangsalam No.25, Dusun III, Karangsalam Kidul, Kec. Kedungbanteng, Kabupaten Banyumas, Jawa Tengah 53152</li>
          </ul>
        </div>
      </div>
...
const dropdownMenus = [
  ...
  },
  {
    ...
    items: [
      { label: 'Kepuasan Mahasiswa', href: 'https://forms.gle/xxxxx' },
      { label: 'Kepuasan Dosen', href: 'https://forms.gle/xxxxx' },
      { label: 'Kepuasan Tendik', href: 'https://forms.gle/xxxxx' },
      { label: 'Kepuasan Mitra Pendidikan', href: 'https://forms.gle/xxxxx' },
      { label: 'Kepuasan Mitra Penelitian', href: 'https://forms.gle/xxxxx' },
      { label: 'Kepuasan Mitra Pengabdian', href: 'https://forms.gle/xxxxx' },
